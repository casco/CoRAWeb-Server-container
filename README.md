...
* run-once.sh will do some additional work to get your server ready (run it only once) - wait a few minutes (two or three) and then kill the process with crtl+C.
